...
void FORTRAN(calcdamage,(ITG *ipkon,char *lakon,ITG *kon,double *co,ITG *mi,
			 double *thicke,ITG *ielmat,ITG *ielprop,double *prop,
			 ITG *ne0,ITG *ndmat_,ITG *ntmat_,ITG *ndmcon,
			 double *dmcon,double *dam,double *dtime,double *sti,
			 ITG *ithermal,double *t1,double *xstate,
			 double *xstateini,ITG *nstate_,double *vold,
			 ITG *idamage,ITG *imode,double *alphaevent));

void FORTRAN(calcdamagebase,(ITG *ipkon,char *lakon,ITG *kon,double *co,ITG *mi,
			 double *thicke,ITG *ielmat,ITG *ielprop,double *prop,
			 ITG *ne0,ITG *ndmat_,ITG *ntmat_,ITG *ndmcon,
			 double *dmcon,double *dam,double *dambase,double *dtime,
...
/* configurable fracture termination: is there still a chain of surviving
   elements between two named node sets */

void FORTRAN(damnonlocalset,(double *ell));
...
void FORTRAN(damfloat,(ITG *ipkon,ITG *kon,char *lakon,ITG *ne,ITG *ne0,
          ITG *nk,ITG *nodeboun,ITG *nboun,ITG *ipompc,ITG *nodempc,
          ITG *nmpc,ITG *batchmax,ITG *nfloat,ITG *nreach,
          ITG *nfcoh,ITG *nfisl));

void FORTRAN(damfloatstab,(ITG *ipkon,ITG *kon,char *lakon,ITG *ne,
          ITG *nk,ITG *nodeboun,ITG *nboun,ITG *ipompc,ITG *nodempc,
          ITG *nmpc,ITG *nodestab,ITG *nstab));

void FORTRAN(damfaildead,(ITG *ipkon,char *lakon,ITG *ne,double *xstate,
          ITG *nstate_,ITG *mi,ITG *batchmax,ITG *ndead));

/* crack-band well-posedness check for the DE1/DM2 displacement law */

void FORTRAN(damsnapcheck,(double *co,ITG *kon,ITG *ipkon,char *lakon,
          ITG *ne0,ITG *ielmat,ITG *mi,ITG *ndmcon,double *dmcon,
          ITG *ndmat_,ITG *ntmat_,double *elcon,ITG *ncmat_,
          double *plicon,ITG *nplicon,ITG *npmat_,double *ratmax,
          ITG *ielmax,ITG *nbad));

/* UNSYM stage 2: rank-1 asymmetric damage contribution of the bulk
...
void FORTRAN(resultsmech,(double *co,ITG *kon,ITG *ipkon,char *lakon,ITG *ne,
	  ...
	  double *aut,ITG *irowt,ITG *jqt,ITG *mortartrafoflag,
	  ITG *intscheme,double *physcon,double *dam,ITG *hasdamage,
	  ITG *de12onepass,ITG *de12tangent,ITG *ndmat_,ITG *ndmcon,double *dmcon,
	  double *dambase,double *damjac,double *damvisc,
	  double *damviscini,double *damvisceta));
